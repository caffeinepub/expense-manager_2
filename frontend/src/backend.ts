...
import type { Summary as _Summary, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addExpense(arg0: string, arg1: string, arg2: number, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getSummary(): Promise<Summary> {
        if (this.processError) {
            try {
                ...
                return from_candid_Summary_n6(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_Summary_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Summary): Summary {
...
function from_candid_record_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        lowestExpense: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.lowestExpense)),
        totalExpense: value.totalExpense,
        highestExpense: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.highestExpense))
    };
}
